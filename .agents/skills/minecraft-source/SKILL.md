...
```
bash .agents/skills/minecraft-source/scripts/decompile-fabric.sh   <class-name>
bash .agents/skills/minecraft-source/scripts/decompile-neoforge.sh <class-name>
```
...
```
bash .agents/skills/minecraft-source/scripts/decompile.sh <class-name>
```
