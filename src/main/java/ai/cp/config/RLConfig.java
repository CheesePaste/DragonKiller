...
public class RLConfig {
    ...
    public static final double REWARD_DISTANCE = 0.01;     // base reward at dist=0, decays exponentially
    ...
    public static final double REWARD_VOID_PENALTY = -5.0; // per tick over void
